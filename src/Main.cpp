...
void AssociateExtension()
{
    ...
    std::wstring alias = L"FlorCodeProfile64";
    std::wstring desc = L"FlorCode 64-bit injection profile";
#else
    std::wstring ext = L".xpr";
    std::wstring alias = L"FlorCodeProfile";
    std::wstring desc = L"FlorCode injection profile";
#endif 
